...
$boleto = new Wlrsilveira\LaravelBoletos\Boleto\Banco\Itau([
    ...
    'qr_code_style'          => Wlrsilveira\LaravelBoletos\Boleto\Banco\Itau::QRCODE_ESTILO_PONTO,
]);

$pdf = new Wlrsilveira\LaravelBoletos\Boleto\Render\Pdf();
$pdf->addBoleto($boleto);
$pdf->setLocalizacaoPix(Wlrsilveira\LaravelBoletos\Boleto\Render\Pdf::PIX_INSTRUCAO);
//$pdf->setLocalizacaoPix(Wlrsilveira\LaravelBoletos\Boleto\Render\Pdf::PIX_COD_BARRAS);
