...
$boleto = new Wlrsilveira\LaravelBoleto\Boleto\Banco\Itau([
    ...
    'qr_code_style'          => Wlrsilveira\LaravelBoleto\Boleto\Banco\Itau::QRCODE_ESTILO_PONTO,
]);

$pdf = new Wlrsilveira\LaravelBoleto\Boleto\Render\Pdf();
$pdf->addBoleto($boleto);
$pdf->setLocalizacaoPix(Wlrsilveira\LaravelBoleto\Boleto\Render\Pdf::PIX_INSTRUCAO);
//$pdf->setLocalizacaoPix(Wlrsilveira\LaravelBoleto\Boleto\Render\Pdf::PIX_COD_BARRAS);
